...
function App() {
	return (
		<div className="App">
			<Header>
				<Navigation />
				<LoginBtn accessKey='' aria-label='Закрыть'>LOGIN</LoginBtn>
			</Header>
			<Block>
				<Title>Accessibility</Title>
				<Form>
					<div>
						<Label aria-hidden htmlFor="1">Label for field 1</Label>
						<Field tabIndex={3} id="1" placeholder="Field 1" />
					</div>

					<div>
						<Label htmlFor="2">Label for field 2</Label>
						<Field tabIndex={1} required id="2" placeholder="Field 2" />
					</div>

					<div>
						<Label htmlFor="3">Label for field 3</Label>
						<Field tabIndex={2} readOnly id="3" placeholder="Field 3" />
					</div>
				</Form>
			</Block>
		</div>
